...
using mvc_test_course.Models;

namespace mvc_test_course.Content
{
    public class ProductController : Controller
    {
        ...
        {
            var product = db.Products.Where(p => p.ProductName.StartsWith(Productname));
            return View("Index", product.ToList());

        }
        public PartialViewResult SearchPartial(string Productname)
        {
            var product = db.Products.Where(p => p.ProductName.StartsWith(Productname));
            return PartialView ("_SearchPartial", product.ToList());
